                        ...
                        <div class="card">
                                <div class="card-body">
                                    <form class="form" role="form" method="POST" action="/register">
    									...
    									<input type="text" class="form-control" placeholder="sponsor's username" value="<?php if($referrer != null): ?><?php echo e($referrer->username, false); ?><?php endif; ?>" name="referrer">
										...
										<div class="form-group">
    										...
    										<input type="text" class="form-control" placeholder="Bank" name="bank" value="<?php echo e(old('bank'), false); ?>" >
                                        ...
                                        <div class="form-group<?php echo e($errors->has('accountno') ? ' has-error' : '', false); ?>">
    										...
    										<input type="text" class="form-control" placeholder="Account number/Wallet Address" value="<?php echo e(old('accountno'), false); ?>" name="accountno">
