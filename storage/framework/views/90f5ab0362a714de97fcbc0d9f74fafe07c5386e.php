...
<html lang="en">
<head>
    <title>CashSpring | <?php if(Request::segment(1) == ''): ?> Home <?php else: ?> <?php echo e(ucfirst(Request::segment(1)), false); ?> <?php endif; ?></title>
    <!-- Meta tag Keywords -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta charset="UTF-8" />
    <meta name="keywords" content="Bitcoin, trading, gain" />
    <meta name="csrf-token" content="<?php echo e(csrf_token(), false); ?>">
    <meta name="description" content="CashSpring Multi-level Marketing Company." />
                    ...
                    <div class="row border-bottom py-lg-4 py-3">
                        <div class="col-md-8 col-lg-6 header_agileits_left">
                            <ul>
                                        ...
                                        <a href="mailto:support@CashSpring.com.ng">support@CashSpring.com.ng</a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <nav class="navbar navbar-expand-lg navbar-light bg-light">
                            <a class="navbar-brand" href="<?php echo e(url('/'), false); ?>">CashSpring
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav ml-auto">
                                ...
                                <li class="nav-item mx-xl-2 mx-lg-1 my-lg-0 my-2 <?php echo e(Request::is('about') ? 'active':'', false); ?>">
                                    <a class="nav-link" href="<?php echo e(url('/coupon'), false); ?>">Coupon</a>
                                </li>
            ...
            <div class="modal-body">
                <div class="login px-4 mx-auto mw-100">
                   ...
                   <form class="form" role="form" method="POST" action="#">
    									...
    									<input type="text" class="form-control" placeholder="uplines's username" value="system" name="referrer">
...
<div class="copy_right py-4 text-center">
    <p class="text-white">© 2020 CashSpring. All rights reserved
    </p>
</div>
<!-- //copyright -->
