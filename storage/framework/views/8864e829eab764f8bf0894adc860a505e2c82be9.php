                                ...
                                <form id="investment-form" action="<?php echo e(url('/investment-request'), false); ?>" method="post">
                                    ...
                                    <div class="form-check">
                                        <label class="form-check-label">
                                            <input type="radio" name="amount" class="form-check-input" value="100" checked onchange="document.getElementById('result').innerHTML = (document.getElementById('usd-bitcoin-rate').value * this.value).toFixed(6);" /> Coiner  ($100.00)
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <label class="form-check-label">
                                            <input type="radio" name="amount" class="form-check-input" value="1000" onchange="document.getElementById('result').innerHTML = (document.getElementById('usd-bitcoin-rate').value * this.value).toFixed(6);" /> Diamond Investment ($1,000.00)
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <label class="form-check-label">
                                            <input type="radio" name="amount" class="form-check-input" value="10000" onchange="document.getElementById('result').innerHTML = (document.getElementById('usd-bitcoin-rate').value * this.value).toFixed(6);" /> Gold Investment ($10,000.00)
                                        </label>
                                    </div>
