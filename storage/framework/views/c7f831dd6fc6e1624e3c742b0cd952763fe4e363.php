									...
									<div class="col-md-12">
										<table class="table table-condensed">
											<tr class="success"><td><b>Total Paid Amount</b></td><td><b>&#8358;<?php echo e(number_format($paid_withdrawals, 2), false); ?></b></td></tr>
												<tr class="success"><td><b>Total Paid Users</b></td><td><b><?php echo e($paid_users_count, false); ?></b></td></tr>
										</table>
									</div>
								</div>
							</div>
									...
									<table class="table">
										...
										<tbody>
											...
											<tr  <?php if($t->suspended): ?> class="success" <?php elseif(!$t->activated): ?> class="warning" <?php endif; ?>>
	                                            ...
	                                            <td>
	                                                	<?php if(!$t->suspended): ?>
	                                                <a href="/admin/user/<?php echo e($t->id, false); ?>/suspend" style="margin-top:5px; margin-bottom:5px;" class="btn btn-sm btn-info">
													    Confirm Payment
													</a>
	                                                <form style="display:none;" id="confirm-payment-form-<?php echo e($t->id, false); ?>" class="form" role="form" method="POST" action="/admin/user/<?php echo e($t->id, false); ?>/suspend">
	            										<?php echo e(csrf_field(), false); ?>

	            										<input type="hidden" value="<?php echo e($t->withamt, false); ?>" name="transaction" >
	            									</form>
	                                                 <?php endif; ?>
	                                             </td>
											</tr>
