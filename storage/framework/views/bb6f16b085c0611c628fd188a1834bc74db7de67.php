								...
								<table class="table">
									...
									<tbody>
										...
										<tr>
											...
											<td><a href="/admin/message/<?php echo e($m->id, false); ?>" <?php if($m->message_read == 0): ?> style="font-weight:900;" <?php endif; ?>><?php echo e(isset($m->sender_data->email) ? $m->sender_data->email : 'Support', false); ?></a></td>
											<td><a href="/admin/message/<?php echo e($m->id, false); ?>" <?php if($m->message_read == 0): ?> style="font-weight:900;" <?php endif; ?>><?php echo e(isset($m->subject) ? $m->subject : '', false); ?></a></td>
								...
								<table class="table">
									...
									<tbody>
										...
										<tr>
											...
											<td><a href="/admin/message/<?php echo e($m->id, false); ?>"><?php echo e(isset($m->receiver_data->email) ? $m->receiver_data->email : 'support', false); ?></a></td>
											<td><a href="/admin/message/<?php echo e($m->id, false); ?>"><?php echo e(isset($m->subject) ? $m->subject : '', false); ?></a></td>
